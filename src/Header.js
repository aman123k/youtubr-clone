...
function Header() {
  ...
  return (
    <>
      <header className=" sticky top-0 bg-white flex items-center z-50">
        ...
        >
          ...
          <div
            ...
            ${
              search
                ? "max-[800px]:w-full max-[800px]:absolute"
                : "max-[800px]:hidden"
            }  
         `}
          >
          ...
          <div
           ...
           ${search ? "max-[800px]:gap-3 max-[800px]:hidden" : ""}   
          `}
          >
            <IoIosSearch
              className={` cursor-pointer 
